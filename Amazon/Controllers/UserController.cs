...
namespace Amazon.Controllers
{
    public class UserController : Controller
    {
        ...
        [HttpPost]
        public ActionResult contactus(Amazon.Models.marketuser model)
        {
        ...
        {
            List<Amazon.Models.marketuser> md = new List<Models.marketuser>();
            var query = (from wlist in db.wishlist_product
                         join plist in db.product_master on wlist.productid equals plist.productid
                         select new
                         {
                             plist.productid,
                             plist.productimage,
        ...
        [HttpPost]
        public ActionResult changepassword(Amazon.Models.marketuser model)
        {
        ...
        [HttpPost]
        public ActionResult login(Amazon.Models.marketuser md)
        {
            var u = (from userlist in db.user_master
        ...
        [HttpPost]
        public ActionResult register(Amazon.Models.marketuser model)
        {
            //validate captcha 
        ...
        [HttpPost]
        public ActionResult forgotpassword(Amazon.Models.marketuser md)
        {
            var u = (from userlist in db.user_master
